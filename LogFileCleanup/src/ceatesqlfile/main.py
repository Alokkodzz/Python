...
def push_to_s3(zip_file, bucket_name, object_name=None, region_name="us-east-1"):
    ...
    if object_name is None:
        ...
        archived_files_data.append({'file_name' : archive_csv.file, 
                                          'original_path' : archive_csv.file_path, 
                                          'new_path' : ExportedFiles,
                                          'file_time_details' : archive_csv.file_mod_time,
                                          'archive_file' : object_name
                })
    
        create_sql_file(archived_files_data, sql_file_path)
